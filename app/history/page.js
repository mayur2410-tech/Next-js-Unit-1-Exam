    ...
    <div className="space-y-4">
      ...
      <form className="flex gap-2">
        <input
          ...
          className="rounded border px-3 py-2 bg-gray-50 dark:bg-gray-900 flex-1"
        />
          ...
          <ul className="space-y-2">
            {result.map((g) => (
              <li key={g._id} className="border rounded p-3 flex items-center justify-between">
                ...
                <a
                  className="px-3 py-1 rounded bg-gray-100 dark:bg-gray-800 border"
                  href={`/history/${g._id}`}
                >
                  Replay
                </a>
